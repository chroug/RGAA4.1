...
import testerCritere13_9 from './criteres/critere_13.9.js';
...
export default async function runTheme13(page, resultats_globaux) {
    ...
    // 6. Test 13.9 (Orientation de l'écran)
    const res13_9 = await testerCritere13_9(page);
    ...
    resultats_globaux["critere_13.9"] = res13_9;
}